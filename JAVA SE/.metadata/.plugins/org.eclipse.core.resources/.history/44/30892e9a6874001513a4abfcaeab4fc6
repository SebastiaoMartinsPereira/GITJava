...
public class BlackJack {
	...
	public static void jogar(){
		...
		System.out.println("Deseja Inciar a Partida 1-Sim / 2-Não?");
		res = scan.nextInt();
		
		if (res==1){
			
            System.out.println("Valores iniciais da pontuação:\n");
		    ...
		    System.out.println("Mais uma rodada ?  1-Sim / 2-Não");
			res = scan.nextInt();
			...
			while(res ==1){
			    ...
			    if(cliente.mostraPontos() > 21){
			    	System.out.println("Estourou a pontuação.");
			    	res=2;
			    }else{
			    	System.out.println("Mais uma rodada ?  1-Sim / 2-Não");
					res = scan.nextInt();
					...
					if(res==2){
						...
						System.out.println("Você :" + cliente.mostraPontos());
						System.out.println("Banca :" + banca.mostraPontos());
