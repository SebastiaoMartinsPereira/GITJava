...
public class Contato {
	...
	/**
	 * Contrutor com definição de valores para todos o satributos da classe..
	 * @param id
	 * @param nome
	 * @param email
	 * @param endereco
	...
	/**
	 * Contrutor com deinição de valores para todos os atributos (a dataNascimento pode ser passada com uma string.)
	 * @param id
	 * @param nome
	 * @param email
	 * @param endereco
	 * @param dataNascimento  Data de nascimento do tipo String.
	 * @exception  ParseException caso o formato da string não obedeça ao formato desejado para parseamento. (dd-MM-yyyy)
	 */
	...
	public String toString(){
		...
		//Define o formato que a data de nascimento será exibida.
		SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/YYYY");
